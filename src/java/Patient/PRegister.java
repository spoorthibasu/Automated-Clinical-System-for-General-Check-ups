...
@WebServlet(name = "PRegister", urlPatterns = {"/PRegister"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try {
            ...
            PreparedStatement psmt = con.prepareStatement("select * from pregistration where pemail='" + Email + "' and  pphone='" + Contatct + "'");
