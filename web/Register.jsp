...
<!--                <header class="page_header header_color template_header subpage_header table_section toggle_menu_left">
                ...
                <div style="">
                    ...
                    <div class="form-style-9">
                        <form action="Register" onsubmit="return  ValidateFun()" method=" post">
                            <ul>
                                <li>
                                ...
                                <li>
                                    <input type="text"  class="field-style field-full align-none" name="spec" id="Password" placeholder="Specalization" />
                                </li>
                                <li>
