...
<!--                <section class="intro_section page_mainslider">
                ...
                <h1  style="color:#000">Welcome to Your Profile<span  style="color:blue">
                        <%
                            String uemail = (String) session.getAttribute("pname");
                            if (uemail != null) {
                                out.print(uemail);
                            }
                        %>
                            ...
                            <div class="col-md-offset-4 col-md-8">
                                <div class="form-style-9">
                                    ...
                                    <%
                                        ...
                                        Object pid = (Object) session.getAttribute("pid");
                                        PreparedStatement stmt11 = con1.prepareStatement("select * from pregistration where pid='" + pid + "'");
                                    ...
                                    <form action="../EditProfile">
                                        <ul>
                                            ...
                                            <li>
                                                <span>Name</span>
                                                <input type="text"   class="field-style field-full align-none" name="name" value="<%=rs.getString("pname")%>" id="name" placeholder="User Name" readonly="">
                                            </li>
                                            <li>
                                                <span>Phone</span>
                                                <input type="text"  class="field-style field-full align-none" name="Contatct" id="Contatct" value="<%=rs.getString("pphone")%>" placeholder="Contatct Number" />
                                            </li>
                                            <li>
                                                <span>Email</span>
                                                <input type="text"  readonly="" class="field-style field-full align-none" name="Email" value="<%=rs.getString("pemail")%>" id="Email" placeholder="Email" />
                                            </li>
                                            <li>
                                                <span>Address</span>
                                            ...
                                            <li>
                                                <span>City</span>
                                                <input type="text"  class="field-style field-full align-none" name="city" value="<%=rs.getString("pcity")%>" id="city" placeholder="city" />
                                            </li>
                                            <li>
                                                <span>Pincode</span>
