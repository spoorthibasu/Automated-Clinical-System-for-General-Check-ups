                            ...
                            <div class="col-md-offset-4 col-md-8">
                                <div class="form-style-9">
                                    ...
                                    <form action="../AddVendors" method="post">
                                        <ul>
                                            <li>
                                                <h1>Add Vender Details</h1>

                                            </li>
                                            <li>
                                                <input type="text"  class="field-style field-full align-none" name="vname"   placeholder="Vender Name" />
                                            </li>
                                            <li>
                                                <input type="email"  class="field-style field-full align-none" name="vemail"   placeholder="Vender  EmailId" />
                                            </li>
                                            <li>
                                                <input type="number"  class="field-style field-full align-none" name="vphone"   placeholder="Vender Phone" />
                                            </li>
                                    ...
                                    <table class="table_template greylinks margin_0" id="timetable">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                PreparedStatement stmt11 = con1.prepareStatement("select * from venders where Pha_pk_id='" + uid + "' and isactive=1");
                                                ResultSet rs = stmt11.executeQuery();
                                                while (rs.next()) {
                                            %>
                                            <tr>
                                                <td><%=count++%></td>
                                                <td><%=rs.getString("VenderName")%></td>
                                                <td><%=rs.getString("VenderEmailId")%></td>
                                                <td><%=rs.getString("VenderPhone")%></td>
                                                <td><a href="DeleteVendor.jsp?rid=<%=rs.getInt("rid")%>">Delete</a></td>
